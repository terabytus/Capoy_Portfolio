      ...
      <div className="relative bg-[var(--color-primary)] rounded-2xl shadow-2xl max-w-7xl w-full max-h-[95vh] overflow-y-auto overflow-x-hidden modal-content transform transition-all duration-500 animate-slideInUp">
        ...
        <section className="my-16 mx-8">
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 bg-[var(--color-primary)]/40 backdrop-blur-sm ">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="w-full lg:w-2/3 bg-gray-100 rounded-xl overflow-hidden shadow-md h-72 sm:h-80 md:h-96">
                  <img
            ...
            <div className="col-span-12 md:col-span-6 bg-[var(--color-primary)]/40 backdrop-blur-sm">
              <div className="flex flex-col h-full">
                <div className="bg-gray-100 rounded-xl overflow-hidden shadow-md mb-4 h-56 sm:h-64 md:h-80">
                  <img
                ...
                <h3 className="font-family-subheader text-[var(--color-highlight)] text-lg font-semibold mb-2 ">
                  Low-Fidelity Wireframes
                </h3>
                <p className="font-family-subheader text-[var(--color-textmain)] text-sm mr-8 mb-4">
            ...
            <div className="col-span-12 md:col-span-6 bg-[var(--color-primary)]/40 backdrop-blur-sm ">
              ...
              <p className="font-family-subheader text-[var(--color-textmain)] text-sm mr-8 mb-8">
              ...
              <div className="flex justify-end gap-4 mx-4 mb-2">
                {project.liveDemoUrl && (
                  <a
                    href={project.liveDemoUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-6 py-3 font-medium bg-[var(--color-accent)] hover:bg-[var(--color-accent)] text-[var(--color-textmain)] rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-[var(--color-highlight)] focus:ring-offset-2 text-base"
                  >
                    Live Demo
                  </a>
                )}
                {project.githubRepoUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-6 py-3 border-2 border-[var(--color-highlight)] text-[var(--color-highlight)] bg-transparent font-medium rounded-full transition-all duration-200 hover:bg-[var(--color-accent)] hover:text-[var(--color-textmain)] hover:border-[var(--color-accent)] hover:scale-105 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[var(--color-highlight)] focus:ring-offset-2 text-base"
                  >
                    Github Repository
                  </a>
                )}
